...
import { igamingDatabase } from "@/lib/sql-engine/igaming-dataset";

export function IgamingTableExplorer({
  onInsert,
}: {
  onInsert: (snippet: string) => void;
}) {
  const [open, setOpen] = React.useState<string[]>(["players"]);
...
{`players ──┬──< wallets ──< transactions >── bets ──< bet_settlements
          ├──< bets
          ├──< kyc_verifications
